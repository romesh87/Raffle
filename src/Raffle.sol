...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /**
     * @dev This is the function that Chainlink nodes will call to see if the lottery is ready to be picked.
     * The following is needed to be true in order to upkeepNeeded to be true:
